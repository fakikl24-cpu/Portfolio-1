...
confession <- confession %>%
 mutate(
    Poli_Orientation = fct_other(as_factor(Q106), drop = c("1", "2", "3")) 
  )

ggplot(data = confession, aes(x = RECODEConfAttend)) +
  geom_bar()+
  facet_wrap(~Poli_Orientation, nrow = 2) +
  labs(title = "Plot of Well-Being and Confession Attendance",
       subtitle = "Faceted by Political Orientation",
